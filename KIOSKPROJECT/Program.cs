...
namespace KIOSK
{
    ...
    class Program
    {
                        ...
                        if (cardNotValid == false)      //if card is valid
                        {
                            ...
                            if (moneyRequestSummary[1] != "declined")
                            {
                                ...
                                if (moneyRequestSummary[1] != "declined" && totalOwed == 0)     //if total is fully paid
                                {
                                    ...
                                    TransactionInfo.transactionNumber = transactionNumber;
                                    TransactionInfo.transactionCardPaymentAmt = totalOwed;
                                    //TransactionInfo.transactionCardVendor = "CASH";
                                    //TransactionInfo.transactionChangeGiven = changeAndRefundAmt[1] * -1;
        ...
        static void StartLogger(string transactionInfo)
        {
            ...
            string[] transactionArray = new string[7];
            transactionArray = transactionInfo.Split(' ');
                
            ProcessStartInfo startInfo = new ProcessStartInfo();
            startInfo.FileName = "C:\\Users\\cockus fattus\\OneDrive\\Desktop\\important shit\\KioskLogger\\KioskLogger\\bin\\Debug\\KioskLogger.exe";
        ...
        {   //get cardnum as array
            ...
            if (total % 10 == 0)
            {
                if (cardVendorNum == 3)
                {
                    ...
                    TransactionInfo.transactionCardVendor = "AmericanExpress";
